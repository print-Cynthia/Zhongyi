...
(function (root, factory) {
    ...
    return {
        version: "1.0",
        desc: "身体信号整理模块 · 中医语料库（PRD §3.3 三大层级）。Layer1 体征标准化规范表、Layer2 问诊推导逻辑表（十问篇）、Layer3 结构化归纳与草本映射表。",
        categories: [
            {
                ...
                depth_prompts: {
                    pain_nature: {
                        ...
                        options: ["刺痛，位置固定不移", "闷痛 / 胀痛，像有东西压着", "隐痛，劳累后明显", "放射到肩背或手臂"],
                        dimension: "property"
                    },
                    trigger: {
                        question: "通常在什么情况下加重或诱发？（可多选）",
                        options: ["劳累 / 活动后", "情绪激动 / 紧张", "受凉 / 受风后", "夜间平卧时明显"],
                        dimension: "trigger"
                    }
                },
            ...
            },
            {
                ...
                depth_prompts: {
                    emotion: {
                        ...
                        options: ["容易急躁、一点就着", "生闷气、压抑不舒", "遇事思虑过多", "无明显情绪问题"],
                        dimension: "emotion"
                    },
                    pain_nature: {
                        question: "胁肋部位的不适性质？（可多选）",
                        options: ["胀闷走窜、叹气则舒", "刺痛固定", "胀痛连及胸乳", "遇怒加重"],
                        dimension: "property"
                    }
                },
            ...
            },
            {
                ...
                depth_prompts: {
                    appetite: {
                        ...
                        options: ["食欲不振、吃得很少", "食后腹胀不消化", "喜温喜按、受凉加重", "口淡乏味、恶心"],
                        dimension: "diet"
                    },
                    stool: {
                        question: "大便情况更接近哪一种？（可多选）",
                        options: ["稀溏 / 腹泻", "黏腻不爽", "夹有不消化食物", "正常成形"],
                        dimension: "excretion"
                    }
                },
            ...
            },
            {
                ...
                depth_prompts: {
                    kidney_symptom: {
                        ...
                        options: ["腰膝酸软、久站加重", "畏寒肢冷、得暖则舒", "头晕耳鸣、精神不振", "夜尿频繁、起夜≥2次"],
                        dimension: "body"
                    },
                    urination: {
                        question: "小便与水肿情况？（可多选）",
                        options: ["夜尿多、尿色清长", "下肢或眼睑水肿", "排尿无力", "无明显异常"],
                        dimension: "excretion"
                    }
                },
            ...
            },
            {
                ...
                depth_prompts: {
                    fever_pattern: {
                        ...
                        options: ["怕冷重、发热轻、无汗", "发热重、怕风、有汗", "寒热往来、一阵冷一阵热", "仅局部咽痛、无明显寒热"],
                        dimension: "property"
                    },
                    accompaniment: {
                        question: "伴随症状有哪些？（可多选）",
                        options: ["鼻塞流涕、打喷嚏", "咽痛、咽干", "咳嗽、咳痰", "头痛身酸、乏力"],
                        dimension: "body"
                    }
                },
                ...
                formulas: [
                    ...
                    },
                    {
                        ...
                        tcm_explanation: "风温犯肺、肺失清肃，故咳嗽痰少、咽痛微热。该思路重在疏风清热、宣肺止咳，是针对“风温袭肺”轻证方向的知识性参考。",
